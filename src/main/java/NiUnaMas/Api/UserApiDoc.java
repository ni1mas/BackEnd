...
public interface UserApiDoc {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Invalid user: DNI, phone or email already taken.", response = ApiError.class) })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Invalid credentials: The email or the password does not mach", response = ApiError.class) })
